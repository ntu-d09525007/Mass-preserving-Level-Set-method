...
real(8) :: momx,momy,momz,dv
    ...
    do i = p%loc%is, p%loc%ie
        ...
        momx = momx + p%loc%heavy%now(i,j,k)*p%loc%nvel%x%now(i,j,k)*dv
        momy = momy + p%loc%heavy%now(i,j,k)*p%loc%nvel%y%now(i,j,k)*dv
        momz = momz + p%loc%heavy%now(i,j,k)*p%loc%nvel%z%now(i,j,k)*dv

...
real(8):: e0, e
    ...
    write(*,'(A20, 2ES15.4)')"Surface Energy:", p%glb%es, p%glb%es0
    write(*,'(A20, 2ES15.4)')"Kinectic Energy:", p%glb%ek, p%glb%ek0
    write(*,'(A20, 2ES15.4)')"Potential Energy:", p%glb%ep, p%glb%ep0
